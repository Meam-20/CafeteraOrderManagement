...
private:
    struct MenuItem
    {
     ...
     MenuItem* menu; // Pointer to dynamically allocated menu items
    int menuSize; // Size of the menu
  ...
  public:
    ...
    {
        menuSize = 10;
        menu = (MenuItem*)calloc(menuSize, sizeof(MenuItem)); // Allocate memory using calloc

        menu[0] = {1, "Burger", 80};
        menu[1] = {2, "Pizza", 200};
        menu[2] = {3, "Coffee", 100};
        menu[3] = {4, "Sandwich", 90};
        menu[4] = {5, "Soda", 25};
        menu[5] = {6, "Fried Rice", 180};
        menu[6] = {7, "Pasta", 150};
        menu[7] = {8, "Noodles", 100};
        menu[8] = {9, "Soup", 80};
        menu[9] = {10, "Momo", 70};
    }
    ...
    ~Cafeteria()
    {
        free(menu); // Free allocated memory
    }
